...
import { products, formatZAR } from "../data/products.js";
          ...
          >
            ...
            <div className="p-8">
              ...
              <div className="mt-6 flex items-center justify-between">
                <span className="text-gold text-xl font-medium">{formatZAR(p.price)}</span>
      ...
      {visible < products.length && (
        <div className="mt-16 text-center">
          <button
            ...
            className="gold-outline-btn px-12 py-4 text-sm rounded-sm"
          >
            Load More
          </button>
        </div>
